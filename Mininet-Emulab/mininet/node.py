...
### Adding code for ExaBGP Docker image
class DockerExaBGP(Docker):
	def __init__(self, name, software="exabgp", **kwargs):
...
class OVSSwitch( Switch ):
    ...
    def attach( self, intf ):
        ...
        self.cmd( 'sudo', 'ifconfig', intf, 'up' )
        self.TCReapply( intf )
