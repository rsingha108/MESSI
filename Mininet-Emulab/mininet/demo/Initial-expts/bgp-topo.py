...
subprocess.run(["sudo", "docker", "stop", "mn.s5"])
...
subprocess.run(["sudo", "docker", "rm", "mn.s5"])
...
s3 = net.addDocker('s3', dimage="kathara/frr:latest", cls=DockerRouter, 
	                     bgpd='yes') 
	                     
s4 = net.addDocker('s4', dimage="kathara/frr:latest", cls=DockerRouter, 
	                     bgpd='yes')
	                    
s5 = net.addDocker('s5', dimage="kathara/frr:latest", cls=DockerRouter, 
	                     bgpd='yes') 
...
snet7 = Subnet(ipStr="5.0.0.0", prefixLen=8)
...
ip1 = snet7.assignIpAddr("5.5.5.1")
ip2 = snet7.assignIpAddr("5.5.5.2")
net.addLink(s5, s4, ip1=ip1, ip2=ip2) 
snet7.addNode(s5, s4)
