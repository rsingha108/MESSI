...
info('*** Adding subnets\n')
snet1 = Subnet(ipStr="2.0.0.0", prefixLen=8) 
snet2 = Subnet(ipStr="1.0.0.0", prefixLen=8)
...
ip1 = snet1.assignIpAddr("2.2.2.1") 
ip2 = snet1.assignIpAddr("2.2.2.2")
net.addLink(s3, s2, ip1=ip1, ip2=ip2) 
snet1.addNode(s3, s2)

ip1 = snet2.assignIpAddr("1.1.1.2") 
ip2 = snet2.assignIpAddr("1.1.1.1")
net.addLink(s2, s1, ip1=ip1, ip2=ip2) 
snet1.addNode(s2, s1)
...
net.addLink(s1, d3, ip1=ip1, ip2=ip2) 
snet4.addNode(s1, d3)
