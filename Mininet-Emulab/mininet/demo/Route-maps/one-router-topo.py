...
img_dict = {'quagga' : "kathara/quagga:latest", 'frr' : "frr8:latest", 'bird' : "ibhde/bird4:latest"} # frr-ubuntu20:latest, kathara/frr:latest, frr-debian:latest
...
# subprocess.run(["docker", "stop", "mn.d1"])
# subprocess.run(["docker", "stop", "mn.s1"])
# subprocess.run(["docker", "stop", "mn.s2"])

# subprocess.run(["docker", "rm", "mn.d1"])
# subprocess.run(["docker", "rm", "mn.s1"])
# subprocess.run(["docker", "rm", "mn.s2"])
